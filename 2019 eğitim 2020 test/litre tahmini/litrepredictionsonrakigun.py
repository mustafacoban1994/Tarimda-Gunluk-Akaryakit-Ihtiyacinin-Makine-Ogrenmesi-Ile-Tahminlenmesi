...
predModels = sc.fit_transform(predModels)
predModels = pd.DataFrame(predModels)
predModels = predModels.transpose()

#predModelsSc = []
y_test = sc.fit_transform(y_test) 
#for i in range (len(predModels)):
#    predModels[i] = predModels[i].reshape

#yPredKnnSc = sc.fit_transform(yPredKnn)
#for i in range(len(models)):
#    predModels[i] = sc.fit_transform(predModels[i]) 
