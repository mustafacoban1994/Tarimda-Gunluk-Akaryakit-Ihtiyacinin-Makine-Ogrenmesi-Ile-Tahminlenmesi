...
x_train_impDtc = xForDtrClass.iloc[startPoint:splint, :].values
x_test_impDtc = xForDtrClass.iloc[splint:, :].values

x_train_impDtr = xForDtrReg.iloc[startPoint:splint, :].values
x_test_impDtr = xForDtrReg.iloc[splint:, :].values

x_train_impKnn = xForKnn.iloc[startPoint:splint, :].values
x_test_impKnn = xForKnn.iloc[splint:, :].values

x_train_impLr = xForLogisticRegression.iloc[startPoint:splint, :].values
x_test_impLr = xForLogisticRegression.iloc[splint:, :].values

x_train_impNn = xForNn.iloc[startPoint:splint, :].values
x_test_impNn = xForNn.iloc[splint:, :].values

x_train_impRfc = xForRfc.iloc[startPoint:splint, :].values
x_test_impRfc = xForRfc.iloc[splint:, :].values

x_train_impSvm = xForSvm.iloc[startPoint:splint, :].values
x_test_impSvm = xForSvm.iloc[splint:, :].values

x_train_impXgb = xForXgb.iloc[startPoint:splint, :].values
